...
public class StaccatoMidiEventFactory implements MidiEventFactory {
	/**
     * Creates a MIDI event for a note-on message with staccato articulation.
	...
	/**
     * Creates a MIDI event for a note-off message with staccato articulation.
